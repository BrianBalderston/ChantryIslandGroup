...
<section class="row">
	...
	<div id="section3" class="small-10 small-offest-1 small-pull-1 medium-offset-1 medium-10 medium-pull-1 columns">    
		...
		<h3 class="hide">Image Googly Guys</h3>
			<a data-open="hidden-gallery">
				<img src="images/googl/googlguysthumb.PNG" alt="googlthumb" id="googlpic">
			</a>


	<div class="large reveal" id="hidden-gallery" data-reveal>
		<img src="images/ChantryIslandPics/MHS_logo.png" alt="galleryplaceholder">
	...
	<?php
	   		if(!is_string($getImages)){
				while($row = mysqli_fetch_array($getImages))
				{
					...
					echo "<img src=\"images/{$row['images_simg']}\" alt=\"{$row['images_name']}\" id=\"{$row['images_id']}\" >";
					echo "</a>";
				}
					}else{
